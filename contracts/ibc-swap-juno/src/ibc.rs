...
use crate::ibc_msg::{
    AcknowledgementMsg, BalancesResponse, DispatchResponse, PacketMsg, WhoAmIResponse, SwapResponse,
};
...
pub fn ibc_packet_ack(
    ...
    match packet {
        ...
        PacketMsg::IbcSwap { .. } => {
            let res: AcknowledgementMsg<SwapResponse> = from_slice(&msg.acknowledgement.data)?;
            acknowledge_swap(deps, env, caller, res)
...
fn acknowledge_swap(
    ...
    Ok(IbcBasicResponse::new().add_attribute("action", "acknowledge_swap"))
}
