...
impl Msg for QueryPoolRequest {
    type Proto = proto::osmosis::gamm::v1beta1::QueryPoolRequest;
}

impl TryFrom<proto::osmosis::gamm::v1beta1::QueryPoolRequest> for QueryPoolRequest {
    type Error = StdError;

    fn try_from(proto: proto::osmosis::gamm::v1beta1::QueryPoolRequest) -> StdResult<QueryPoolRequest> {
        QueryPoolRequest::try_from(&proto)
    }
}
...
impl From<QueryPoolRequest> for proto::osmosis::gamm::v1beta1::QueryPoolRequest {
    fn from(msg: QueryPoolRequest) -> proto::osmosis::gamm::v1beta1::QueryPoolRequest {
        proto::osmosis::gamm::v1beta1::QueryPoolRequest::from(&msg)
    }
}

impl From<&QueryPoolRequest> for proto::osmosis::gamm::v1beta1::QueryPoolRequest {
    fn from(msg: &QueryPoolRequest) -> proto::osmosis::gamm::v1beta1::QueryPoolRequest {
        proto::osmosis::gamm::v1beta1::QueryPoolRequest {
            pool_id: msg.pool_id,
        }
    }
}
...
impl Msg for QueryPoolResponse {
    type Proto = proto::osmosis::gamm::v1beta1::QueryPoolResponse;
}

impl TryFrom<proto::osmosis::gamm::v1beta1::QueryPoolResponse> for QueryPoolResponse {
    type Error = StdError;

    fn try_from(proto: proto::osmosis::gamm::v1beta1::QueryPoolResponse) -> StdResult<QueryPoolResponse> {
        QueryPoolResponse::try_from(&proto)
    }
}
...
impl TryFrom<&proto::osmosis::gamm::v1beta1::QueryPoolResponse> for QueryPoolResponse {
    ...
    fn try_from(proto: &proto::osmosis::gamm::v1beta1::QueryPoolResponse) -> StdResult<QueryPoolResponse> {
        Ok(QueryPoolResponse {
            pool: proto.pool.clone().unwrap(),
        })
    }
}

impl From<QueryPoolResponse> for proto::osmosis::gamm::v1beta1::QueryPoolResponse {
    fn from(msg: QueryPoolResponse) -> proto::osmosis::gamm::v1beta1::QueryPoolResponse {
        proto::osmosis::gamm::v1beta1::QueryPoolResponse::from(&msg)
    }
}

impl From<&QueryPoolResponse> for proto::osmosis::gamm::v1beta1::QueryPoolResponse {
    fn from(msg: &QueryPoolResponse) -> proto::osmosis::gamm::v1beta1::QueryPoolResponse {
        proto::osmosis::gamm::v1beta1::QueryPoolResponse {
            pool: msg.pool.clone().into(),
        }
    }
}